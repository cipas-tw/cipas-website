                    ...
                    <ul class="list">
                        ...
                        <li class="caption">
                            <div class="row-w-limit">
                                <a href="/<?php echo $this->router->fetch_class() ?>/<?php echo $val['purchase_id'];?>" class="doc-title"><?php echo $val['purchase_title'];?></a>
                                <div class="desc"><?php echo strip_tags(mb_substr($val['purchase_content'], 0, 70, 'UTF-8'));?></div>
                            </div>
                        </li>
                        <?php
                        }
